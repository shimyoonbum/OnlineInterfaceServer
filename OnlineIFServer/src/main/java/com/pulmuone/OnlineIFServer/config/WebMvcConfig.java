...
public class WebMvcConfig implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(beforeActionInterceptor).addPathPatterns("/**").excludePathPatterns("/resource/**").excludePathPatterns("/common/getInterfaces")
				.excludePathPatterns("/users/doLogin")
				.excludePathPatterns("/users/doLogout")
				.excludePathPatterns("/users/setPassword")
				.excludePathPatterns("/users/register")
				.excludePathPatterns("/users/getSession")
				.excludePathPatterns("/users/getProxySession")
				.excludePathPatterns("/common/meta")
				.excludePathPatterns("/common/trigger")
				.excludePathPatterns("/member/login")
				.excludePathPatterns("/member/doLogin")
				.excludePathPatterns("/member/join")
				.excludePathPatterns("/member/doJoin")
				.excludePathPatterns("/article/list")
				.excludePathPatterns("/article/detail")
				.excludePathPatterns("/restore/getData");		
		...
		// 로그인, 로그인처리, 가입, 가입 처리는 로그인 상태일 때 접근할 수 없다.
//		registry.addInterceptor(authInterceptor).addPathPatterns("/users/getSession");
	}
}
